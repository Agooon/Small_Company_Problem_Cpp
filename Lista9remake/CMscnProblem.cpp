...
void CMscnProblem<int>::vGenerateInstance(int d, int f, int m, int s, int iInstanceSeed) {
	...
	int sredniaS = this->myGenerator.iRandInt(rand_min_sSomething, rand_max_sSomething);
...
void CMscnProblem<double>::vGenerateInstance(int d, int f, int m, int s, int iInstanceSeed) {
	...
	double sredniaS = this->myGenerator.dRandDouble(rand_min_sSomething, rand_max_sSomething);
	std::cout << std::endl << "Srednia wylosowana na seed(" << iInstanceSeed << "): " << sredniaS;
